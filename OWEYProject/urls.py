"""
URL configuration for OWEYProject project.
...
urlpatterns = [
    ...
    path('', TemplateView.as_view(template_name='base.html', extra_context={
        'title': 'Главная',
        'environment': Directory.objects.filter(parent=None),
        'current_dir': None,
    }), name='home'),
